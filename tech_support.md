...
Working _locally_ simply refers to developing code using software
...
Working _remotely_ means using an environment that someone else set up
...
wrong with this, _per se_, and it is simpler, but you should think of
