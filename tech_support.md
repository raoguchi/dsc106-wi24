...
Labs and projects in DSC 106 are mostly coding assignments, so it's important to make sure that your computing environment is set up properly. You will need Git, VSCode, and Node to complete all labs and projects.
...
In order to make our lives easier when we develop websites, we are going to use some VS Code extensions. Up to lab 6, it is only necessary to install the following two extensions. Come back when you need to work on lab 6; more information will be updated.

### 1.3.1 Prettier

This is an extension that will help us keep our code clean and tidy. You may find out more for this extension [here](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode). Click "Install" on the webpage. It will redirect to your VSCode; then, click "Install" again to install the extension.

### 1.3.2 Live Preview

This will host a local server in our workspace for us to preview our web pages on. You may find out more for this extension [here](https://marketplace.visualstudio.com/items?itemName=ms-vscode.live-server). Click "Install" on the webpage. It will redirect to your VSCode; then, click "Install" again to install the extension.



<!--

### 1.3.3 Svelte for VS Code
...
If everything is installed correctly, you should see their respective version numbers below each command, e.g. in my terminal I can see this:

![img](./assets/clip_image002.gif)

The following versions will be ok to use in the context of 6/11.C35:
